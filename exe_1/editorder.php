...
$orderResult = mysqli_query($conn, "SELECT * FROM orders WHERE OrderID='$OrderID'");
...
<body>
    ...
    <div class="order-box">
        ...
        <form action="process_edit_order.php" method="POST">
            ...
            <input id="OrderID" type="text" name="OrderID" value="<?php echo htmlspecialchars($order['OrderID']); ?>" readonly>

            <label for="CusID">Customer</label>
            <select id="CusID" name="CusID" required>
                <?php while ($customer = mysqli_fetch_assoc($customers)) { ?>
                    <option value="<?php echo $customer['CusID']; ?>" <?php if ($customer['CusID'] == $order['CusID']) echo "selected"; ?>>
            ...
            <select id="ProductID" name="ProductID" required>
                <?php while ($product = mysqli_fetch_assoc($products)) { ?>
                    <option value="<?php echo $product['ProductID']; ?>" <?php if ($product['ProductID'] == $order['ProductID']) echo "selected"; ?>>
            ...
            <input id="Quantity" type="number" name="Quantity" min="1" value="<?php echo htmlspecialchars($order['Quantity']); ?>" required>
